...
public class Runway {
	...
	public String toString() {
		return "Runway [id=" + id + ", airport_ref=" + airport_ref + ", airport_ident=" + airport_ident + ", length_ft=" + length_ft + ", width_ft=" + width_ft + ", surface=" + surface + ", lighted="
				+ lighted + ", closed=" + closed + ", le_ident=" + le_ident + ", le_latitude_deg=" + le_latitude_deg + ", le_longitude_deg=" + le_longitude_deg + ", le_elevation_ft=" + le_elevation_ft
				+ ", le_heading_degT=" + le_heading_degT + ", le_displaced_threshold_ft=" + le_displaced_threshold_ft + ", he_ident=" + he_ident + ", he_latitude_deg=" + he_latitude_deg
				+ ", he_longitude_deg=" + he_longitude_deg + ", he_elevation_ft=" + he_elevation_ft + ", he_heading_degT=" + he_heading_degT + ", he_displaced_threshold_ft="
